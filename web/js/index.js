...
$(function () {
    ...
    $(window).resize(function () {
        ...
        if (browserW < 1390) {
            picLiW = 510;
        } else if (browserW < 1655 && browserW > 1390) {
            picLiW = 560;
        } else if (browserW > 1655) {
            picLiW = 760;
        }
        //获取mod-2右边模块的长度；
        $(".right-pic").css({
        ...
        if (browserH < 768) {
            ...
            //设置二维码位置
            $(".twoCode").css("marginTop", 0.35 * browserH);

        } else if (browserH < 1080 && browserH >= 768) {
            $(".mod-2-inside").css("top", 0.3 * browserH);
            $(".twoCode").css("marginTop", 0.38 * browserH);
        } else if (browserH > 1080) {
            $(".mod-2-inside").css("top", 0.3 * browserH);
            $(".twoCode").css("marginTop", 0.38 * browserH);
        }
    ...
    $(".mod-sm-lf").click(function () {
        ...
        $(".right-pic").stop().animate({
            ...
            $(".leftWord li").eq(rightPage).fadeIn().siblings().fadeOut();
